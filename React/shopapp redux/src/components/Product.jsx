...
const Product = ({ post }) => {
    ...
    return (
        ...
        hover:scale-110 transition duration-300 ease-in gap-3 p-4 mt-10 ml-5 rounded-xl'>
            <div>
                <p className='text-gray-700 font-semibold text-lg text-left truncate w-40 mt-1 shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)]'>{post.title}</p>
            </div>
            <div>
